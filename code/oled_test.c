...
void testfullchar() {
    ...
    for(i = 0; i < 1275; i++){
        ...
        drawChar(x, y, font[i], WHITE, WHITE, 1);
        //increment x
        x += 8;
...
void testhelloworld() {
    ...
    drawChar(5, 60, 'H', BLACK, BLACK, 2);
    drawChar(15, 60, 'e', BLACK, BLACK, 2);
    drawChar(25, 60, 'l', BLACK, BLACK, 2);
    drawChar(35, 60, 'l', BLACK, BLACK, 2);
    drawChar(45, 60, 'o', BLACK, BLACK, 2);
    //skip 55 for space
    drawChar(65, 60, 'W', BLACK, BLACK, 2);
    drawChar(75, 60, 'o', BLACK, BLACK, 2);
    drawChar(85, 60, 'r', BLACK, BLACK, 2);
    drawChar(95, 60, 'l', BLACK, BLACK, 2);
    drawChar(105, 60, 'd', BLACK, BLACK, 2);
    drawChar(115, 60, '!', BLACK, BLACK, 2);
